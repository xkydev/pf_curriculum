...
@RequestMapping(value = "/v1/auth/faculties/{facultyId}/acad_programs/{acadprogramId}/assessemnt_plans/{asgplaId}/cycles/"
        + "{asgplacycleId}/subcycles/{asgplasubcycleId}/assmt_plan_outs/{aspnoutId}/assmt_plan_pis/{aspnpiId}/perf_indicator")
public interface AuthAssmtPlanPiPerformanceIndicatorController {
